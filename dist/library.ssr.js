...
var __vue_render__ = function() {
  ...
  return _c(
    "span",
    { staticClass: "filter filter-container" },
    [
      _vm._ssrNode(
        '<span class="filter-icons"><button type="button"' +
          _vm._ssrClass(null, [
          ...
          '><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon-svg feather feather-filter"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"></polygon></svg></button></span> '
      ),
      _vm._ssrNode(
        '<div class="filter-body"' +
          _vm._ssrStyle(null, null, {
            display: _vm.filtersVisable ? "" : "none"
          }) +
          ">",
        "</div>",
        [
          _vm._ssrNode(
            '<div class="filter-controls-container js-ignore-click"><div class="filter-controls js-ignore-click"><input type="text" placeholder="Start typing..." name="name-filter"' +
              _vm._ssrAttr("value", _vm.search) +
              ' class="filter-controls__name-filter js-ignore-click"> <button type="button" class="btn btn-danger btn-sm btn-close-filter js-ignore-click"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon-svg feather feather-minus-square js-ignore-click"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="8" y1="12" x2="16" y2="12"></line></svg></button> <button type="button" class="btn btn-light btn-sm js-ignore-click"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon-svg feather feather-arrow-down js-ignore-click"><line x1="12" y1="5" x2="12" y2="19"></line><polyline points="19 12 12 19 5 12"></polyline></svg></button> <button type="button" class="btn btn-light btn-sm js-ignore-click"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon-svg feather feather-arrow-up js-ignore-click"><line x1="12" y1="19" x2="12" y2="5"></line><polyline points="5 12 12 5 19 12"></polyline></svg></button></div></div> '
          ),
          _vm._ssrNode('<form class="form-inline">', "</form>", [
            _c(
              "select",
              {
                directives: [
...
__vue_render__._withStripped = true;
  ...
  /* module identifier */
  const __vue_module_identifier__ = "data-v-63048c89";
  /* functional template */
  ...
  return _vm.show
    ? _c("tr", { staticClass: "table-row" }, [
        _vm._ssrNode(
          "<td>" +
            (_vm.entity["_html_"]
              ? "<span>" + _vm._s(_vm.entity["_html_"]) + "</span>"
              : "<span><a" +
                _vm._ssrAttr("href", this.url + "/edit/" + _vm.entity.id) +
                '><button type="button" class="btn btn-outline-primary btn-edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button></a></span>') +
            "</td> " +
            _vm._ssrList(_vm.columns, function(column) {
              return "<td><span>" + _vm._s(_vm.entity[column]) + "</span></td>"
            })
        )
      ])
    : _vm._e()
...
__vue_render__$1._withStripped = true;
  ...
  /* module identifier */
  const __vue_module_identifier__$1 = "data-v-917bd094";
  /* functional template */
      ...
      [
        _vm._ssrNode("<thead>", "</thead>", [
          _vm._ssrNode(
            ...
            "</tr>",
            [
              _vm._ssrNode('<th class="table-row-buttons"></th> '),
              _vm._l(_vm.columnsArray, function(column) {
                return _vm._ssrNode(
                  '<th scope="col"' +
                    _vm._ssrClass("table-col-title", ["table-col-" + column]) +
                    ">",
                  "</th>",
                  [
                    column !== "flags"
...
__vue_render__$2._withStripped = true;
  ...
  /* module identifier */
  const __vue_module_identifier__$2 = "data-v-32c4a7fe";
  /* functional template */
